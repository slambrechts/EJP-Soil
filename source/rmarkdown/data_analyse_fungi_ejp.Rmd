...
# Remove samples
phyloseq_venn_location <- subset_samples_no_zero(phyloseq_venn, Location != "Deurne")
phyloseq_venn_filtered <- subset_samples_no_zero(phyloseq_venn_location, Location != "Herentals")
