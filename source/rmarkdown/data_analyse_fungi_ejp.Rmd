...
physeq_srs <- subset_samples_no_zero(physeq_srs, Locatie != "Gontrode")
physeq_nonrarefied <- subset_samples_no_zero(physeq_nonrarefied, Locatie != "Gontrode")
physeq_nonrarefied_merged <- subset_samples_no_zero(physeq_nonrarefied_merged, Locatie != "Gontrode")

physeq_srs <- subset_samples_no_zero(physeq_srs, Protocol2 != "strooisel")
physeq_nonrarefied <- subset_samples_no_zero(physeq_nonrarefied, Protocol2 != "strooisel")
physeq_nonrarefied_merged <- subset_samples_no_zero(physeq_nonrarefied_merged, Protocol2 != "strooisel")

physeq_known_species <- subset_taxa(physeq_nonrarefied_merged, !grepl("_otu", tax_table(physeq)[, "species"]))
physeq_known_genera <- subset_taxa(physeq_nonrarefied_merged, !grepl("_otu", tax_table(physeq)[, "genus"]))
physeq_known_order <- subset_taxa(physeq_nonrarefied_merged, !grepl("_otu", tax_table(physeq)[, "order"]))
physeq_known_family <- subset_taxa(physeq_nonrarefied_merged, !grepl("_otu", tax_table(physeq)[, "family"]))
physeq_known_class <- subset_taxa(physeq_nonrarefied_merged, !grepl("_otu", tax_table(physeq)[, "class"]))

physeq_srs_known_species <- subset_taxa(physeq_srs, !grepl("_otu", tax_table(physeq)[, "species"]))
physeq_srs_known_genera <- subset_taxa(physeq_srs, !grepl("_otu", tax_table(physeq)[, "genus"]))
physeq_srs_known_order <- subset_taxa(physeq_srs, !grepl("_otu", tax_table(physeq)[, "order"]))
physeq_srs_known_family <- subset_taxa(physeq_srs, !grepl("_otu", tax_table(physeq)[, "family"]))
physeq_srs_known_class <- subset_taxa(physeq_srs, !grepl("_otu", tax_table(physeq)[, "class"]))
