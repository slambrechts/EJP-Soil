...
locations <- unique(sample_data(physeq_known_species)$Location)

# Extract locations with both INBO and Lucas protocols
locations_with_lucas <- unique(sample_data(physeq_known_species)$Location[sample_data(physeq_known_species)$Protocol2 == "Lucas"])
