...
# Onderstaande beter herschrijven zodat hij automatisch de samples in samples_to_remove verwijderd, in plaats van dat je ze hieronder manueel moet ingeven
...
# Extract locations with both INBO_0_10 and Lucas protocols
...
# Work with ubset only known species

unique(sample_data(physeq_known_species)$Protocol)

locations <- unique(sample_data(physeq_known_species)$Locatie)

# Extract locations with both INBO_0_10 and Lucas protocols
locations_with_lucas <- unique(sample_data(physeq_known_species)$Locatie[sample_data(physeq_known_species)$Protocol == "Lucas"])
