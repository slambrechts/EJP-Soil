...
write.csv(sample_sums, file = "Inse01_full_sample_sums.csv")

# Define the classes to keep
classes_to_keep <- c("Insecta", "Arachnida", "Chilopoda", "Diplura", "Malacostraca")

# Subset the phyloseq object to include only specified classes
physeq_insecta <- subset_taxa(physeq, class %in% classes_to_keep)

sample_sums <- sample_sums(physeq_insecta)


physeq_rarefied <- rarefy_even_depth(physeq, sample.size = )
...
tidy_physeq_insecta <- tidytacos::from_phyloseq(physeq_insecta)
